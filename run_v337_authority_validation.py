...
for name in ("_v337_apply_recommendation_authority", "_v337_final_answer_boundary", "_v336_construct_visitor_answer"):
...
assert "_enforce_recommendation_output_authority" in boundary_source
assert "_enforce_recommendation_resource_identity" in boundary_source
...
print("USE v337 authority validation: PASS")
