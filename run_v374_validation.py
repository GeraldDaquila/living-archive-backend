...
finalize = next(node for node in module.body if isinstance(node, ast.FunctionDef) and node.name == "_v375_finalize")
...
academic_grief_doc = {
    ...
    "text": "grief, meaning, spiritual and scientific wisdom",
}
assert ns["_resource_frame_groups"](academic_grief_doc) == {"worldview"}
...
print("USE v375 visitor-experience structural validation: PASS")
