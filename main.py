...
def _claim_type(sentence):
    ...
    if re.search(r"\b(?:relates to|connected with|linked to|pathway|stewardship|creation|meaning|transcenden|growth|receiv|giv|loss|grief|mourning|forgiv|truth|discernment|knowledge|wisdom)\b",low): return "relationship"
    return "exploration"
