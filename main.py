...
def _build_factual_answer(query,docs):
    ...
    if supporting:
        cleaned=". ".join(s.rstrip(".") for s in supporting)+"."; parts.append(f"The Archive develops that idea through themes such as {cleaned}")
