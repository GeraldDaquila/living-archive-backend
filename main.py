...
def _secondary_role(doc: dict):
    ...
    if evidence["belonging_connection"] and not evidence["direct_loneliness"]:
        return "belonging", "a route into connection and belonging", 12
    return None
