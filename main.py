...
if "living archive" not in _V475_FOUNDATION_AUDIT.casefold() or "Overflow" not in _V475_FACTUAL_AUDIT or ".." in _V475_FACTUAL_AUDIT or "Connected to the earliest flameholders" in _V475_FACTUAL_AUDIT:
